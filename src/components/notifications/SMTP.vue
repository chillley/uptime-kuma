<template>
    <div>
        ...
        <div class="mb-3">
            ...
            <input id="from-email" v-model="$parent.notification.smtpFrom" type="text" class="form-control" required autocomplete="false"
        ...
        <div class="mb-3">
            ...
            <input id="to-email" v-model="$parent.notification.smtpTo" type="text" class="form-control" autocomplete="false" placeholder="example2@kuma.pet, example3@kuma.pet"
        ...
        <ToggleSection :heading="$t('smtpDkimSettings')">
            ...
            <div class="mb-3">
                ...
                <textarea id="dkim-private-key" v-model="$parent.notification.smtpDkimPrivateKey" rows="5" type="text" class="form-control" autocomplete="false"
